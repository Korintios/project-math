...
export default function SimpsonOne() {
    ...
    const calcularIntegral = (e) => {
        ...
        let nNum = Number(n);
        if (nNum % 2 !== 0) {
            nNum++; // Asegurarse de que n es par para el método de Simpson 1/3
        }
        ...
        for (let i = 0; i <= nNum; i++) {
            ...
            const coeficiente = (i === 0 || i === nNum) ? 1 : (i % 2 === 0 ? 2 : 4);
            const contribucion = coeficiente * fx * h / 3;
    ...
    return (
        <div className='flex flex-row gap-6'>
            <div className='flex flex-col gap-8 w-[70%]'>
                <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Método de Simpson 1/3</h1>
                ...
                <div className="relative overflow-x-auto">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <EmptyTable data={puntosGrafico} columns={5}/>
